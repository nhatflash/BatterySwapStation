...
public class PaymentController {
    ...
    @GetMapping("/process")
    public ResponseEntity<ApiResponse<String>> processPayment(@RequestParam UUID transactionId, HttpServletRequest request) {
        var response = paymentService.createVnPayUrl(transactionId, request);
